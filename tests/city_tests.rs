...
mod tests {
    ...
    pub fn test_city_constructor() {
        let city = city::City { id: 1, latitude: 52.5200, longitude: 13.4050 };
    ...
    pub fn test_city_distance(){
        ...
        let city_origin = city::City { id: 1, latitude: 35.6850, longitude: 139.7510 };
        for (id,lat,lon) in city_tests {
            let city = city::City { id, latitude: lat, longitude: lon };
